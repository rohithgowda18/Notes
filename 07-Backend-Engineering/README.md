...
| 📝 [Error Handling and Building Fault Tolerant Systems.md](./Error%20Handling%20and%20Building%20Fault%20Tolerant%20Systems.md) | Circuit Breakers (Resilience4j / Hystrix), Exponential Backoff & Jitter, Retries, Fallbacks, Bulkheads, Idempotency keys, and Rate Limiting. |
| 📝 [Task queues and background jobs.md](./Task%20queues%20and%20background%20jobs.md) | Message Queues (RabbitMQ, Kafka, SQS, Redis Pub/Sub), Background Workers, Delivery Guarantees (At-least-once, Exactly-once), Dead Letter Queues (DLQ), and Scheduled Jobs. |
